<template>
  <div>
    ...
    <div v-else>
      ...
      <div v-else>
        <h1 v-html="genreName" class="text-white font-poppins font-semibold text-xl mb-5 capitalize"></h1>
...
<script>
  ...
  export default {
    ...
    computed: {
      genreName() { return this.genre.replace(/\W/g, " ") + " Manga" },
    },
    watch: {
      page: {
        handler: 'fetchData',
    ...
    methods: {
      ...
      async fetchData() {
        ...
        Service.getMangaGenre(genre, page)
          .then((response) => {
